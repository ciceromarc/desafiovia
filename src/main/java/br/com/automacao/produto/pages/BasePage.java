...
public class BasePage {
	...
	public String geradorCNPJ() throws Exception {
		...
		numerosContatenados = String.valueOf(n1) + String.valueOf(n2) + String.valueOf(n3) + String.valueOf(n4)
				...
				+ String.valueOf(n10) + String.valueOf(n11) + String.valueOf(n12);
	...
	public String gerarCNPJ() throws Exception {

		String resultadoCNPJ = geradorCNPJ();
